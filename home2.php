...
<nav class="navbar navbar-expand-md  navbar-dark justify-content-end" style="background-color: #8C52FF; font-family: Cairo">
  ...
  <div class="container mt-4">
    ...
    <div class="col text-center">
      <a href="./areasestudo/linguagens2.html"><img src="./fotos/linguagens.png" class="img-fluid animate__animated animate__zoomIn "></a>
    </div>
		<div class="container mt-4">
		<div class="row">
		<div class="col text-center">
		<a href="./areasestudo/humanas2.html"><img src="./fotos/humanas.png" class="img-fluid animate__animated animate__zoomIn"></a>
		</div>
    <div class="container mt-4">
    <div class="row">
		<div class="col text-center">
			<a href="./areasestudo/natureza2.html"><img src="./fotos/natureza.png" class="img-fluid animate__animated animate__zoomIn"></a>
		</div>
  </div>
  </div>
   <div class="container mt-4 mb-5">
    <div class="row">
    <div class="col text-center">
      <a href="./areasestudo/basetecnica2.html"><img src="./fotos/basetec.png" class="img-fluid animate__animated animate__zoomIn"></a>
    </div>
